    ...
    <div className='wrap'>
      ...
      <div className="box1">
        ...
        <div className="box1-1">
          <p>
            まず、深川先生に感謝をしたいです。ありがとうございます。そして、小野寺さん、谷崎さん、ありがとうございます。<br />入校してからプログラミングを学んで
            分かったことがあります。プログラミングは泥臭いことなのだと。機能を追加してはバグをつぶしていくことなのだと。でも、それが自分の思うように動いたときは
            本当に嬉しいものなんだと、卒業制作で感じました。これからもプログラミングを好きになっていけたらなと思います。ありがとうございました！
